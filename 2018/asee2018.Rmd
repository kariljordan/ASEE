...
ggplot(round2data_status_tally,
  ...
  theme_classic() +
  xlab("Figure 3: Respondents' Status") +
  ylab("% Respondents") +
  ggtitle("") +
...
round2data %>%
  ...
  ggplot(pre_and_post_usage,
    ...
    scale_x_discrete(labels = function(x) lapply(strwrap(x,
                                                 ...
                                                 collapse = "\n")) +
    theme_classic() +
    xlab("Figure 4: Respondents' Programming Usage Increased") +
    ylab("% Respondents") +
...
title <- ""
plot(data_agree_likert, type =c("heat"), panel.arrange = NULL, panel.strip.color = "red", legend.position = "bottom") + ggtitle(title) + labs(x = "", y="Figure 6: Perception of Workshop Impact")
...
ggplot(round1data_country_tally,
  ...
  theme_classic() +
  xlab("") +
  ylab("Figure 2: Breakdown of Respondents by Country") +
  coord_flip() +
  ggtitle("") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme_bw(base_size = 14)
