...
ggplot(round2data_status_tally, 
  ...
  theme_classic() +
  xlab("Figure 2: Respondents' Status") +
  ylab("% Respondents") +
  ggtitle("") +
...
ggplot(round1data_country_tally,
  ...
  theme_classic() +
  xlab("") +
  ylab("Figure 3: Breakdown of Respondents by Country") +
  coord_flip() +
  ggtitle("") +
  theme(plot.title = element_text(hjust = 0.5)) +
...
ggplot(round2data_time_since_tally, 
  ...
  scale_x_discrete(labels = function(x) lapply(strwrap(x, width = 10, simplify = FALSE), paste, collapse="\n")) +
  theme_classic() +
  xlab("Figure 4: Time Since Attending Carpentry Workshop") +
  ylab("% Respondents") +
  ggtitle("") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme_classic(base_size = 14)
...
ggplot(stdres,
  ...
  xlab("Figure 7: Respondents program significantly more often") +
...
```{r}
title <- "Table 3: Perception of Workshop Impact"		
