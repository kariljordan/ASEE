...
```{r include=FALSE}
round1data <- readr::read_csv("https://raw.githubusercontent.com/kariljordan/ASEE/master/2018/data_20171108.csv")
...
# Count of open responses for Status
data_statusother_tally <-
  data %>%
